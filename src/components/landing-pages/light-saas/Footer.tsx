...
export default function Footer() {
  return (
<footer 
  className="bg-accent-500 overflow-hidden lg:fixed lg:bottom-0 w-full z-0 selection:bg-white"
>
  <div className="p-8 flex flex-col max-w-screen-2xl mx-auto">
    <div className="grid grid-cols-1 xl:grid-cols-2 gap-px">
      <div
        className="text-base tracking-wide uppercase text-black font-medium p-8 bg-accent-500 rounded-3xl"
      >
        <p>A comprehensive directory for all your needs</p>
        <p className="text-xs" x-text="'Copyright © ' + year + ' Lexington Themes. All Rights Reserved.'"> </p>
      </div>
      <div className="grid grid-cols-1 gap-px sm:grid-cols-3 text-black">
        <ul role="list" className="p-8 bg-accent-600 rounded-4xl">
          <li>
            ...
            <ul role="list" className="mt-4">
              ...
              <li>
                <a className="hover:underline" href="/system/styleguide"
                  >Style Guide</a
                >
              </li>
            </ul>
      ...
      <div className="col-span-full">
        <div className="mt-6 flex flex-col gap-px">
          ...
          <input
            ...
            type="email"
            required
            className="block items-center px-12 text-center w-full rounded-full h-14 border-0 bg-zinc-900 relative border-trasnparent py-1.5 lg:h-24 text-white ring-0 ring-inset ring-transparent lg:text-4xl placeholder:text-zinc-400 focus:ring-2 focus:ring-inset focus:ring-accent-500 sm:text-sm sm:leading-6"
            placeholder="Enter your email"
          />
          <button
            type="submit"
            className="pl-4 lg:pl-12 lg:text-4xl pr-2 bg-zinc-900 border-zinc-900 duration-200 hover:border-zinc-900 h-12 lg:h-24 text-white justify-between uppercase border-2 rounded-full inline-flex items-center"
            >Subscribe

            <div
              className="bg-white h-8 w-8 lg:h-20 lg:w-20 text-black inline-flex items-center justify-center rounded-full"
            >
              <span>
                <svg
    ...
    <svg  className="order-first" viewBox="0 0 56 11" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
